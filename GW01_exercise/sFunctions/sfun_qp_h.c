 ...
 *
 *         void Wrap_qp_h(double u1[], double u2[], double y1[100])
 *
 *    Simulink version           : 9.2 (R2018b) 24-May-2018
 *    C source code generated on : 25-May-2020 20:26:26
 *
...
#define S_FUNCTION_NAME  sfun_qp_h
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "Wrap_qp_h", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
