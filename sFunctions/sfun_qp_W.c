 ...
 *
 *         void Wrap_qp_W(double u1[], double u2[], double y1[19600])
 *
 *    Simulink version           : 9.2 (R2018b) 24-May-2018
 *    C source code generated on : 25-May-2020 21:14:55
 *
...
/**
     ...
     def.OutputFcnSpec = 'void Wrap_qp_W(double u1[], double u2[], double y1[19600])';
...
#define S_FUNCTION_NAME  sfun_qp_W
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "Wrap_qp_W", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
